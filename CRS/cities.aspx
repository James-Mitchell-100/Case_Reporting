<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CRS.Master" CodeBehind="cities.aspx.vb" Inherits="CRS.cities" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Table runat="server" BorderStyle="Solid" BorderWidth="2" CellPadding="5" ID="tblPreferredCities" Visible="True">
    ...
    <asp:Label ID="lblSaveComplete" runat="server" 
                    Text="Thank you for making changes to the Preferred Cities." Visible="False"></asp:Label>
    </asp:Panel>
</asp:Content>
