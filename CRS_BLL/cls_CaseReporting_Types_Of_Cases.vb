...
Imports CRS_DLL
Public Class CaseReporting_Types_Of_Cases
#Region "Properties"

    Public Property Types_Of_Cases As Collection

#End Region


#Region "Public Methods"
    Public Sub GetCaseReportingTypes_Of_CasesCities(ByVal str_TypeOfCase_ID As String)
        ...
        Types_Of_Cases = New Collection

        ''Load the dataset
        ds_data_city = data_cities.Get_City_Info(str_TypeOfCase_ID)
